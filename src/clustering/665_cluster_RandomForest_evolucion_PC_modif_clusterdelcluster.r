...
dchico <- fread("C:/Users/German/Documents/MaestriaDataMining/DMEyF/exp/clu-randomforest/2024-09-21-517717-4clusters/dchico.txt")
...
dwalkingdead <- dwalkingdead[!is.na(cluster)]
