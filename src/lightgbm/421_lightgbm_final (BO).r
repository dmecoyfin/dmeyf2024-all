...
PARAM$finalmodel$num_iterations <- 221
PARAM$finalmodel$learning_rate <- 0.0817241590894138
PARAM$finalmodel$feature_fraction <- 0.628122448043636
PARAM$finalmodel$min_data_in_leaf <- 4049
