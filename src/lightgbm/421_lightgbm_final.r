...
PARAM$semilla_primigenia <- 990653


PARAM$input$dataset <- "C:/Users/vicsa/OneDrive/Documents/Personal/Master_DataScience_UBA/2do Cuatrimestre/DMEyF/data/datasets/competencia_01.csv"
...
for (envios in cortes) {
  ...
  fwrite(tb_entrega[, list(numero_de_cliente, Predicted)],
    file = paste0(PARAM$experimento, "_", envios,"_990653", ".csv"),
    sep = ","
  )
}
