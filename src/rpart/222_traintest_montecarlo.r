...
PARAM$semillas <- c(111667, 517717, 552749, 245083, 571433)
...
# media (promedio) de Testing Total
cat( "testing total: ", tb_salida[, mean(testing)], "\n" )

# media (promedio) de Testing positivo
cat( "testing positivos: ", tb_salida[, mean(testing_pos)], "\n" )

# media (promedio) de estimulos
cat( "estimulos: ", tb_salida[, mean(envios)], "\n" )

# media (promedio) de aciertos
