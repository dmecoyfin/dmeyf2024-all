...
PARAM$semilla_primigenia <- 315697
PARAM$dataset <- "competencia_01_R.csv"
...
hs <- makeParamSet(
  ...
  makeIntegerParam("max.depth", lower = 5, upper = 15),
  makeIntegerParam("min.node.size", lower = 50, upper = 500),
