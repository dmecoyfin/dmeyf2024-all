...
hs <- makeParamSet(
  makeIntegerParam("num.trees", lower = 50L, upper = 200L),
  makeIntegerParam("max.depth", lower = 5L, upper = 20L),
  makeIntegerParam("min.node.size", lower = 10L, upper = 1000L),
  makeIntegerParam("mtry", lower = 5L, upper = 20L),
