...
TS_strategy_base8 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(
    ...
    # 202005, 202004, (los sacamos por recomendación de Euge)
...
wf_SEMI_ago_orden227_rank_cero_fijo_sin_mayo_abril_canaritos_por_defecto <- function( pnombrewf )
{
...
wf_SEMI_ago_orden227_rank_cero_fijo_sin_mayo_abril_canaritos_por_defecto()
