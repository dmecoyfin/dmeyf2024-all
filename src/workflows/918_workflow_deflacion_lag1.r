...
FEhist_base <- function( pinputexps)
{
  ...
  param_local$lag6 <- FALSE # no me engraso con los lags de orden 6
  param_local$lag12 <- FALSE # no me engraso con los lags de orden 12
...
wf_agosto_deflacion_lag1 <- function( pnombrewf )
{
