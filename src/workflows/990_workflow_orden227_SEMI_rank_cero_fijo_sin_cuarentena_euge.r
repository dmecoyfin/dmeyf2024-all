...
TS_strategy_base8 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(
    ...
    # 202006  Excluyo por variables rotas saco202004,202003,202005
    202002, 202001,
    201912, 201911,
  ...
  param_local$train$training <- c(
    ...
    202012, 202011, 202010, 202009, 202008, 202007, 
    # 202006  Excluyo por variables rotas  202005, 202004, 202003
    202002, 202001,
    201912, 201911,
    # 201910 Excluyo por variables rotas
    201909, 201908, 201907, 201906,
...
wf_SEMI_ago_orden227_rank_cero_fijo_sin_cuarentena_euge <- function( pnombrewf )
{
...
wf_SEMI_ago_orden227_rank_cero_fijo_sin_cuarentena_euge()
