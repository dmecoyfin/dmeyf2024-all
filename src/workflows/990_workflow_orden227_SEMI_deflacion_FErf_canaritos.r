...
wf_SEMI_ago_orden227_deflacion_FErf_optim_FM_sin_cuarentena_canaritos <- function( pnombrewf )
{
...
wf_SEMI_ago_orden227_deflacion_FErf_optim_FM_sin_cuarentena_canaritos()
