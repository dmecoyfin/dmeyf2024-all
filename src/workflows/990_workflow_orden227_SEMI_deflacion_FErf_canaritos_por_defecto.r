...
FErf_attributes_base <- function( pinputexps, ratio, desvio)
{
  ...
  param_local$lgb_param <- list(
    ...
    num_iterations = 25, #subo de 20 a 25 por recomendación de Robinson y Cristian
    num_leaves  = 16,
...
TS_strategy_base8 <- function( pinputexps )
{
  ...
  param_local$train$training <- c(
    ...
    202012, 202011, 202010, 202009, 202008, 202007, 
    # 202006  Excluyo por variables rotas
    #excluyo abril y marzo de 2020 por recomendación de Ale Czernikier (202003, 202002) 
    202005, 202004, 202001,
    201912, 201911,
    # 201910 Excluyo por variables rotas
    201909, 201908, 201907, 201906,
    # 201905  Excluyo por variables rotas
...
wf_SEMI_ago_orden227_deflacion_FErf_optim_FM_sin_cuarentena_canaritos_predeterminados <- function( pnombrewf )
{
...
wf_SEMI_ago_orden227_deflacion_FErf_optim_FM_sin_cuarentena_canaritos_predeterminados()
