...
TS_strategy_base8 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(
    202106, 202105, 202103, 202102, 202101, #sacamos 202104 por recomendación de Luciana Pianelli
  ...
  param_local$train$training <- c(
    202103, 202102, 202101, #sacamos 202104 por recomendación de Luciana Pianelli
    202012, 202011, 202010, 202009, 202008, 202007, 
    # 202006  Excluyo por variables rotas
    202005, 202004, 202003, 202002, 202001,
    201912, 201911,
...
wf_SEMI_ago_orden227_deflacion_sin_abril2021_canaritos <- function( pnombrewf )
{
...
wf_SEMI_ago_orden227_deflacion_sin_abril2021_canaritos()
