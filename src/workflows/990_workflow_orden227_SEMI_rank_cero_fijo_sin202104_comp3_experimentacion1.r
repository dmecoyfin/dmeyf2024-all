...
#  param_local$train$training <- c( 202101, 202102, 202103)
  ...
  param_local$lgb_param <- list(
    ...
    num_iterations = 25,  #por defecto 20
    num_leaves  = 16,
...
HT_tuning_semillerio <- function( pinputexps, semillerio, bo_iteraciones, bypass=FALSE)
{
  ...
  param_local$meta$script <- "/src/wf-etapas/2212_HT_lightgbm_SEMI_auc2.r"
...
wf_SEMI_sep_orden227_rank_cero_fijo_sin202104_experimentacion1 <- function( pnombrewf )
{
...
wf_SEMI_sep_orden227_rank_cero_fijo_sin202104_experimentacion1()
