...
wf_junio_variables_evolutivas_iteraciones_random_canaritos <- function( pnombrewf )
{
  param_local <- exp_wf_init( pnombrewf ) # linea workflow inicial fija

  # Etapa especificacion dataset de la Segunda Competencia Kaggle
  DT_incorporar_dataset( "~/buckets/b1/datasets/dataset_super_random.csv.gz")
...
wf_junio_variables_evolutivas_iteraciones_random_canaritos()
