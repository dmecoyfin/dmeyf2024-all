...
wf_junio_variables_evolutivas_iteracion_5_final <- function( pnombrewf )
{
  param_local <- exp_wf_init( pnombrewf ) # linea workflow inicial fija

  # Etapa especificacion dataset de la Segunda Competencia Kaggle
  DT_incorporar_dataset( "~/buckets/b1/datasets/dataset_iter_f202106_5.csv.gz")
...
wf_junio_variables_evolutivas_iteracion_5_final()
