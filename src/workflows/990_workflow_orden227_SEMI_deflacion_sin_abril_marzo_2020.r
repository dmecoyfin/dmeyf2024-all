...
TS_strategy_base8 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(
    ...
    202005, 202002, 202001, #Excluyo 202004, 202003 por recomendación de Ale Czernikier
    201912, 201911,
...
wf_SEMI_ago_orden227_deflacion_sin_abril_marzo2020 <- function( pnombrewf )
{
...
wf_SEMI_ago_orden227_deflacion_sin_abril_marzo2020()
