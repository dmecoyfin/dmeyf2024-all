...
FEintra_manual_propio <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1301_FE_intrames_manual_variables_evolutivas_importantes.r"
...
wf_junio_variables_evolutivas_iteraciones_importantes <- function( pnombrewf )
{
...
wf_junio_variables_evolutivas_iteraciones_importantes()
