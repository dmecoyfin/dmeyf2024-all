...
FEintra_manual_base <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1301_FE_intrames_manual_variables_evolutivas_progresivas.r"
...
wf_junio_variables_evolutivas_iteraciones_progresivas <- function( pnombrewf )
{
...
wf_junio_variables_evolutivas_iteraciones_progresivas()
