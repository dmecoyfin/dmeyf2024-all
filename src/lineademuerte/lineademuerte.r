...
tb_entrega[, Predicted := 0L]
tb_entrega[1:10500, Predicted := 1L]

fwrite(tb_entrega, file = "lineademuerte_10500.csv" )

tb_entrega[, Predicted := 0L]
tb_entrega[1:11500, Predicted := 1L]

fwrite(tb_entrega, file = "lineademuerte_11500.csv" )

tb_entrega[, Predicted := 0L]
tb_entrega[1:12000, Predicted := 1L]

fwrite(tb_entrega, file = "lineademuerte_12000.csv" )
