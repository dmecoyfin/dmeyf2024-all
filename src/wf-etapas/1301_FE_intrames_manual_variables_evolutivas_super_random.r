...
AgregarVariables_IntraMes <- function(dataset) {
  ...
  dataset[, iter_2_var_108 := (mtarjeta_visa_descuentos / Visa_msaldototal) + (cpayroll_trx)]

  dataset[, iter_1_var_117 := mautoservicio + Visa_msaldototal]

  dataset[, iter_1_var_5 := mpayroll / mcuentas_saldo]

  dataset[, iter_2_var_48 := (ccajas_consultas + mtarjeta_visa_consumo) / (ccaja_ahorro)]
  ...
  dataset[, iter_2_var_50 := mcomisiones_mantenimiento / ccaja_ahorro]

  dataset[, iter_1_var_43 := mpayroll / ctarjeta_visa_debitos_automaticos]
